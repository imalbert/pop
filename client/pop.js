...
var POP = {
  ...
  update: function() {
    ...
    if (POP.nextBubble < 0) {
      // put a new instance of bubble 
      // into our entities array
    ...
    var i, 
      checkCollision = false; // we only need to check for a colission if the user tapped on this game tick and then incorporate into the main logic
    ...
    POP.wave.offset = Math.sin(POP.wave.time * 0.8) * 15;
...
POP.Input = {
  ...
  set: function(data) {
    ...
    this.x = (data.pageX - offsetLeft) / POP.scale;
    this.y = (data.pageY - offsetTop) / POP.scale;
    this.tapped = true;
...
POP.Particle = function(x, y, r, col) {
  ...
  // determines whether particle will travel to the 
  // right or left 50% chance of either happening
  ...
  this.update = function() {
    ...
    // increase velocity so pariticle
